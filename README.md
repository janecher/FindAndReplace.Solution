...
This application replace words in a text (take user input text, word needs to be changed, word to replace).
...
|----------|-------|-------|
| Replacement a word | FindAndReplace("Hello world", "world", "universe") | "Hello universe" |
| Takes into account partial matches | FindAndReplace("I am walking my cat to the cathedral", "cat", "dog") | "I am walking my dog to the doghedral." |
